...
function App() {
  return (
    <div className=" h-fit bg-black text-white flex items-center justify-center p-8">
          ...
          <div className="space-y-4">
            <ul className="list-disc pl-6 space-y-4">
              ...
              <li className="text-lg">
                ...
                pertaining to admission, the decision of the Admission Committee
                will be final
              </li>

              <li className="text-lg">
                Parents will be intimated of the date and time of uniform &
                textbook issue
              </li>

              <li className="text-lg">
                School reopening date will be intimated to you in advance. And
                all other details will be intimated to you on timely basis
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="lg:w-1/2">
          <div className="relative perspective-[1000px] transform-style-preserve-3d">
            ...
            <img
              ...
              style={{
                transform:
                  "translate3d(0px, 0px, 0px) scale3d(1, 1, 1) rotateX(8deg) rotateY(-16deg) rotateZ(0deg) skew(0deg, 0deg)",
