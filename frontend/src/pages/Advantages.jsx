...
const advantagesData = [
  {
    ...
    description:
      "A MICROCOSM OF THE MODERN WORLD, PREPARING STUDENTS FOR GLOBAL CHALLENGES.",
  },
  {
    title: "FAMILY ATMOSPHERE",
    description:
      "A WELCOMING AND FAMILY-LIKE ATMOSPHERE THAT NURTURES STUDENTS' WELL-BEING.",
  },
  {
    title: "HIGH STANDARDS",
    description:
      "SETTING AND MAINTAINING HIGH STANDARDS FOR STUDENT ACHIEVEMENT AND EXCELLENCE.",
  },
  {
    title: "FOSTERING CURIOSITY",
    description:
      "FOSTERING LIVELY INTEREST AND CURIOSITY TO INSPIRE LIFELONG LEARNING.",
  },
  {
    title: "INCLUSIVE ENVIRONMENT",
    description:
      "NURTURING A SUPPORTIVE AND INCLUSIVE ENVIRONMENT FOR ALL STUDENTS.",
  },
  {
    title: "PERSONAL GROWTH",
    description:
      "ENCOURAGING PERSONAL AND ACADEMIC GROWTH TO DEVELOP WELL-ROUNDED INDIVIDUALS.",
  },
];
...
const Advantages = () => {
  ...
  return (
    <section
      ref={sectionRef}
      className="bg-black min-h-screen flex items-center justify-center py-12 overflow-hidden relative mt-12"
    >
      <div className="container mx-auto px-4">
        {/* Mobile heading */}
        <h1 className="text-4xl font-bold text-white mb-8 text-center md:hidden">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 relative max-w-4xl mx-auto">
          {advantagesData.map((advantage, index) => (
            ...
            >
              <h2 className="text-3xl sm:text-lg md:text-3xl font-bold mb-2 uppercase text-white px-3 py-2">
                {advantage.title}
              </h2>
              <p className="text-lg md:text-xs sm:text-sm leading-tight text-gray-300 px-3 py-8">
              ...
              >
                ...
                <text fill="black" fontSize="5">
                  <textPath xlinkHref="#circlePath" startOffset="0">
                    VRIKSHA GIVES WINGS TO YOUR CHILD'S DREAM • VRIKSHA GIVES
                    WINGS TO YOUR CHILD'S DREAM •
                  </textPath>
                </text>
              </svg>
            </div>
            <div className="absolute inset-0 flex items-center justify-center">
              <span className="text-black text-sm font-bold text-center leading-tight">
                ADVANTAGES
              </span>
            </div>
          </div>
