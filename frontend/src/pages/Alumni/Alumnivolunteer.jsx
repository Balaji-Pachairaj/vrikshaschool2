      ...
      <div className="w-full max-w-7xl mx-auto">
        <div className={`relative z-10 rounded-3xl bg-[#1a1a1a] shadow-2xl transition-all duration-1000 ease-out ${isInView ? 'opacity-100 scale-100' : 'opacity-0 scale-95'}`}>
          <div className="flex flex-col lg:flex-row items-center justify-between gap-8 p-6 sm:p-10 md:p-12">
            {/* Image on Left */}
            <div className="w-full lg:w-1/2 flex items-center justify-center -mt-8">
              <div className={`relative w-full max-w-lg transition-all duration-1000 delay-500 ease-out ${isInView ? 'opacity-100 scale-100' : 'opacity-0 scale-90'}`}>
            ...
            <div className="w-full lg:w-1/2 space-y-8">
              ...
              <div className={`bg-[#2a2a2a] p-8 sm:p-10 rounded-2xl shadow-lg border border-white/10 transition-all duration-1000 delay-300 ease-out min-h-[200px] ${isInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
